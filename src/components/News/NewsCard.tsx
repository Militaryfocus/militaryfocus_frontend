...
export default function NewsCard({ news }: NewsCardProps) {
    return (
        <div className="group cursor-pointer">
            <div className="relative h-[180px] md:h-[300px] max-[425px]:h-[220px] max-[425px]:w-full max-[425px]:mx-auto overflow-hidden">
                <Image
                    src={news.image}
                    alt={news.title}
                    fill
            ...
            <div className="mt-3 md:mt-4 max-[425px]:w-full max-[425px]:mx-auto">
                <h3 className="font-russo-one text-white text-[16px] md:text-[24px] max-[425px]:text-[16px] leading-tight mb-2 md:mb-[16px] group-hover:text-yellow-500 transition-colors line-clamp-2">
                    {news.title}
                </h3>
