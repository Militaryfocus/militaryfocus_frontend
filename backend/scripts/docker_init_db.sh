...
# Docker Database Initialization Script for ML Community Platform
# This script is used inside Docker containers to initialize the database
...
echo -e "${BLUE}🐳 Initializing ML Community Database in Docker...${NC}"
